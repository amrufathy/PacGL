...
Maze::Maze() {
    Type temp_map[MAZEHEIGHT][MAZEWIDTH] = {
            ...
            {WALL, PATH, PATH, WALL, WALL, WALL, PATH, PATH, PATH, WALL, WALL, WALL, WALL, PATH, PATH, PATH, PATH, PATH, WALL, WALL, WALL, WALL, PATH, PATH, PATH, WALL, WALL, WALL, WALL, PATH, WALL},
            ...
            {WALL, WALL, WALL, WALL, WALL, WALL, PATH, PATH, PATH, WALL, PATH, PATH, PATH, PATH, PATH, WALL, PATH, PATH, PATH, PATH, PATH, WALL, PATH, PATH, PATH, WALL, WALL, WALL, WALL, WALL, WALL},
            {PATH, PATH, PATH, PATH, PATH, WALL, GIFT, PATH, PATH, WALL, PATH, BOMB, PATH, PATH, GIFT, PATH, PATH, PATH, PATH, PATH, PATH, WALL, PATH, PATH, PATH, WALL, PATH, PATH, PATH, PATH, PATH},
            {PATH, PATH, PATH, PATH, PATH, WALL, PATH, PATH, PATH, WALL, WALL, WALL, WALL, PATH, PATH, PATH, PATH, PATH, WALL, WALL, WALL, WALL, PATH, PATH, PATH, WALL, PATH, PATH, PATH, PATH, PATH},
            {WALL, WALL, WALL, WALL, WALL, WALL, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, BOMB, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, WALL, WALL, WALL, WALL, WALL, WALL},
            {WALL, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, GIFT, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, WALL},
            {WALL, WALL, WALL, WALL, WALL, WALL, PATH, PATH, PATH, WALL, PATH, PATH, PATH, PATH, PATH, WALL, PATH, PATH, PATH, PATH, PATH, WALL, PATH, PATH, PATH, WALL, WALL, WALL, WALL, WALL, WALL},
            {PATH, PATH, PATH, PATH, PATH, WALL, PATH, PATH, PATH, WALL, PATH, PATH, PATH, PATH, PATH, WALL, PATH, PATH, PATH, PATH, PATH, WALL, PATH, PATH, PATH, WALL, PATH, PATH, PATH, PATH, PATH},
            {PATH, PATH, PATH, PATH, PATH, WALL, PATH, PATH, PATH, WALL, PATH, PATH, PATH, PATH, PATH, WALL, PATH, PATH, PATH, PATH, PATH, WALL, PATH, PATH, PATH, WALL, PATH, PATH, PATH, PATH, PATH},
            ...
            {WALL, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, WALL},
            {WALL, PATH, PATH, WALL, WALL, WALL, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, PATH, WALL, WALL, WALL, PATH, PATH, WALL},
...
int Maze::gifts_count() {
    int counter = 0;
    for (int i = 0; i < MAZEHEIGHT; i++)
        for (int j = 0; j < MAZEWIDTH; j++)
            if (this->map[i][j] == GIFT)
                counter++;
